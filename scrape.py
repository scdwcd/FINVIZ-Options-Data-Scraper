...
def get_options(dataframe):
      options_list = sum(dataframe["options"].tolist(), [])
...
# Returns dataframe of list of options data, each corresponding to a unique ticker and expiry date
...
dataframe = scrape(["AAPL", "MSFT", "SIGMABOY"], ["2025-07-01 - 2025-07-10", "2025-07-03"])
options = get_options(dataframe)
print(dataframe)
print(options)